...
var PurchaseOrderInShare = Vogels.define('PurchaseOrderInShare', {
    hashKey: 'id',
    rangeKey : 'createdAt',
    timestamps: true,
...
PurchaseOrderInShare.config({
    tableName: 'PurchaseOrderInShare'
});
...
Vogels.createTables(function (err) {
    if (err) {
        ...
        console.log(' New Tables has been created For PurchaseOrderInShare');
    }
});
*/


module.exports = PurchaseOrderInShare;