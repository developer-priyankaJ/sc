...
var ProductInventoryInShare = Vogels.define('ProductInventoryInShare', {
    hashKey: 'id',
    rangeKey : 'createdAt',
    timestamps: true,
...
ProductInventoryInShare.config({
    tableName: 'ProductInventoryInShare'
});
...
/*Vogels.createTables(function (err) {
    if (err) {
        ...
        console.log(' New Tables has been created For ProductInventoryInShare');
    }
});*/


module.exports = ProductInventoryInShare;